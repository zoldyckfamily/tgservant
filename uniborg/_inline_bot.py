...
if Config.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == borg.uid and query.startswith("@meanii"):
            ...
            result = builder.article(
                "@meanii: Noob/xD 👨🏻‍💻",
                text=f"[meanii](https://telegra.ph/file/88a9fc26e29332495f8a7.mp4)",
                buttons=[],
                link_preview=True
            )
        else:
...
**Verified Account:** ✅
**Official Website:** https://gizmostuffgstuff.blogspot.com [⠀](https://telegra.ph/file/88a9fc26e29332495f8a7.mp4)
...
**Custom Built Fork:** https://github.com/mitshuhataki/kaito/""",
                buttons=[
                    ...
                    [custom.Button.url("👨‍💻Source Code👨‍💻", "https://gizmostuffgstuff.blogspot.com/"), custom.Button.url(
