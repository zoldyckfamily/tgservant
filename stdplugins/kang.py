...
async def _(event):
    ...
    packname = f"@whi5tLe_bL0w3R 's KaNG PacK"
    packshortname = f"whi5tlebl0w3RKaNGpacKssss{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"whi5tLe_AnimatedStickers"
        packshortname = f"whi5tLe_Animated"  # format: Uni_Borg_userid
